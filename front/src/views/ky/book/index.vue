            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="图书名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="isbn">
                        <Input type="text" v-model="searchForm.isbn" placeholder="ISBN" clearable style="width: 200px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getBookList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
