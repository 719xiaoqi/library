        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="bookName">
                        <Input type="text" v-model="searchForm.bookName" placeholder="图书名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="借阅人" clearable style="width: 200px" />
                    </Form-item>
...
export default {
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        icon: "ios-settings",
                                        ghost: true,
                                        disabled: !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("edit")) || params.row.status != "未归还"
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
                                    on: {
                                        click: () => {
                                            this.reBookBorrowingFx(params.row);
                                        }
                                    }
                                },
                                "归还"
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getBookBorrowingList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
