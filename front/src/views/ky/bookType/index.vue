            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="图书类型" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="status">
                        <Select v-model="searchForm.status" placeholder="类型状态" clearable style="width: 200px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getBookTypeList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
