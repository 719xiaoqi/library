    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <FormItem label="公告标题" prop="title">
                <Input v-model="form.title" clearable maxlength="240" show-word-limit placeholder="请输入公告标题..." style="width:570px" />
            </FormItem>
            <FormItem label="公告内容" prop="content">
                <Input v-model="form.content" type="textarea" :rows="4" clearable maxlength="240" show-word-limit placeholder="请输入公告内容..." style="width:570px" />
            </FormItem>
